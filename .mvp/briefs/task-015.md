## Task
- id: 015
- title: Реализовать UI практики: встроенный SQL-редактор на CodeMirror, запуск запроса, таблица результата или текст ошибки Postgres как есть, вердикт check-запроса и сброс песочницы.
- level: 7
- service: frontend
- service_path: services/frontend
- role: frontend-implementer
- files: services/frontend/src/features/practice/PracticeView.tsx, services/frontend/src/features/practice/SqlEditor.tsx, services/frontend/src/features/practice/ResultTable.tsx, services/frontend/src/features/practice/usePractice.ts
- depends_on: 011
