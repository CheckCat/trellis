## Task
- id: 013
- title: Реализовать навигацию по курсу: список модулей и уроков со статусами, рендер Markdown-контента урока и кнопка явной отметки «пройдено».
- level: 7
- service: frontend
- service_path: services/frontend
- role: frontend-implementer
- files: services/frontend/src/features/course/CoursePage.tsx, services/frontend/src/features/course/ModuleList.tsx, services/frontend/src/features/lesson/LessonView.tsx, services/frontend/src/features/lesson/Markdown.tsx
- depends_on: 011
