...
import { parseConfig, DEFAULT_COURSES_DIR } from "../config/index.js";
import { createPool, type AppPool } from "../db/pool/index.js";
import { runMigrations } from "../db/migrate/index.js";
import { registerShutdown } from "../lifecycle/index.js";
import { createCourseRegistry, type CourseRegistry } from "../courses/registry/index.js";
import { createProgressRepository, type ProgressRepository } from "../progress/repository/index.js";
import {
...
import capabilitiesRoutes from "../routes/capabilities/index.js";
